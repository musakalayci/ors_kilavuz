...
.. toctree::
   ...
   satırlar/dongu_satırları 
   satırlar/kosullu_satırlar
   satırlar/yönlendirmeler 
   satırlar/durum 
...
Örs ve diğer yazılım dilleri de satırları ifade kümesi olarak algılar. Örnek verelim:
